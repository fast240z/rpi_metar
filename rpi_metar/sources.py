...
class KO61(METARSource):                                                                                                                                                                                                                                                                  URL = 'https://ko61.awos.live'                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              async def scrape_metar(self):                                                                                                                                                                                                                                                             browser = await launch(executablePath='/usr/bin/chromium-browser', args=['--no-sandbox'], headless=True)                                                                                                                                                                              page = await browser.newPage()                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              try:                                                                                                                                                                                                                                                                                      await page.goto(self.URL)                                                                                                                                                                                                                                                             await asyncio.sleep(1)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      # Wait for the METAR data to load using the updated CSS selector                                                                                                                                                                                                                      metar_element = await page.waitForSelector('#OfficialObs')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  # Extract the full METAR data                                                                                                                                                                                                                                                         full_metar = await page.evaluate('(element) => element.textContent', metar_element)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         # Split the string by spaces and select the relevant portion starting with "KO61"                                                                                                                                                                                                     metar_parts = full_metar.split()                                                                                                                                                                                                                                                      metar_data = ' '.join(metar_parts[metar_parts.index('KO61'):]).strip()                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      # Return the METAR data in the specified dictionary format                                                                                                                                                                                                                            metars = {                                                                                                                                                                                                                                                                                'KO61': {'raw_text': metar_data}                                                                                                                                                                                                                                                  }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           return metars                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           except Exception as e:                                                                                                                                                                                                                                                                    print(f'Error: {e}')                                                                                                                                                                                                                                                                  return None                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             finally:                                                                                                                                                                                                                                                                                  await browser.close()                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               async def get_metar_info(self):                                                                                                                                                                                                                                                           return await self.scrape_metar()
